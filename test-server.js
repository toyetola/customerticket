...
const url= "mongodb+srv://oyetola:oyetola24@main.bxiul.gcp.mongodb.net/test-customerticket?retryWrites=true&w=majority"
...
// simple route
app.get("/", (req, res) => {
  res.json({ message: "Welcome, start submitting your ticket: SUBMIT A TICKET."});
});
...
app.use("/api/agent/dashboard", verifyToken, checkSession, agentRoutes); 
